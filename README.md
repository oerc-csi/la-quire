...
***WARNING this version of the Quire Linked Art Extension is not tested. It is a quick experiment for [issue 2](https://github.com/oerc-csi/la-quire/issues/2), do not use in any deployed situation.***
